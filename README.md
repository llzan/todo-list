...
# SCREENSHOTS
    ...
    ## Desktop
        ...
        ### TodoList Page:
        ![Todo App TodoList Page](./screenshots/TodoListPage.png)

        ### About Page:
        ![Todo App About Page](./screenshots/AboutPage.png)

        ### Profile Page: 
        ![Todo App Profile Page](./screenshots/ProfilePage.png)


    ## Mobile

        ### Login Page:
        ![Todo App Login Page](./screenshots/LoginPage-iPhone.png)

        ### TodoList Page:
        ![Todo App TodoList Page](./screenshots/TodoListPage-iPhone.png)

        ### About Page:
        ![Todo App About Page](./screenshots/AboutPage-iPhone.png)

        ### Profile Page: 
        ![Todo App Profile Page](./screenshots/ProfilePage-iPhone.png)
